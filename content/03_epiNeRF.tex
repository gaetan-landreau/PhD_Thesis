...
\begin{figure}[htp!]
    \center
  \includegraphics[width=.65\textwidth]{figures/abstract_figure.png}
...
\begin{figure*}[htb!]
    \center
  \includegraphics[height=6.3cm]{figures/overview_architecture.png}
...
\begin{figure*}[htb!]
    \center
  \includegraphics[height=3.5cm]{figures/feature_fusion_encoder.png}
...
%\end{center}
\end{table}
\footnotetext[3]{SymmNeRF\cite{symmnerf} results differ from the ones originally reported by authors since we had to retrain their architecture.}
...
\begin{figure}[htb!]
    \center
  \includegraphics[height=5cm]{figures/exp-srn-cars.png}
...
\begin{figure}[htb!]
    \center
  \includegraphics[height=6.1cm]{figures/exp-srn-chairs.png}
...
\begin{figure}[htb!]
    \center
  \includegraphics[height=6.cm]{figures/res_standford_cars.png}
...
\begin{figure}[htp!]
    \center
  \includegraphics[height=5cm]{figures/ablation-srn.png}
...
\begin{figure*}[htb!]
  ...
  \begin{subfigure}[t]{0.45\linewidth}
    \includegraphics[height=3cm]{figures/nerfeature.png}
  ...
  \begin{subfigure}[t]{0.51\linewidth}
    \includegraphics[height=3.cm]{figures/feature_visuals.png}
...
\begin{figure*}[htb!]
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \includegraphics[height=2.4cm]{figures/attention_illustration.png}
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \center
    \includegraphics[height=3.3cm]{figures/exp_epipolar_attention.png}
