...
\end{adjustbox}
\end{center}
\captionof{table}{Performance on ShapeNet \citep{chang2015shapenet}. Best scores for the single-view modality are highlighted in bold while second best ones are underlined.}
\label{tab:1}
\end{table}
