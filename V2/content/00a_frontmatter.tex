\begin{titlepage}
    ...
    \flushleft{
      ...
      \begin{tabularx}{\textwidth}{@{\hskip 18pt}Xr}
        Pr. Sylvie \textsc{Chambon} & Rapporteur                 \\[-0.5mm]
        \affil{Professeur des universités, INP-ENSEEIHT} \\[0.5mm]
      \end{tabularx}
      \begin{tabularx}{\textwidth}{@{\hskip 18pt}Xr}
        Pr. Gilles \textsc{Simon} & Rapporteur \\[-0.5mm]
        \affil{Professeur des universités, Laboratoire LORIA, Université de Lorraine }    \\[0.5mm]
      \end{tabularx}
      \begin{tabularx}{\textwidth}{@{\hskip 18pt}Xr}
        Dr. Céline \textsc{Teulière} & Examinatrice        \\[-0.5mm]
        \affil{Maîtresse de conférences, Institut Pascal, Université Clermont Auvergne } \\[0.5mm]
      \end{tabularx}
      \begin{tabularx}{\textwidth}{@{\hskip 18pt}Xr}
        Pr. Pascal \textsc{Monasse} & Examinateur \\[-0.5mm]
        \affil{Professeur des universités, Laboratoire Imagine, Ecole des Ponts ParisTech } \\[0.5mm]
      \end{tabularx}
      \begin{tabularx}{\textwidth}{@{\hskip 18pt}Xr}
